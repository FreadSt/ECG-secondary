import "./style.scss";
import brandText from "../../../assets/fourthpage-images/header-img/brand-text.png";
import HeaderMobile from "../../../assets/fourthpage-images/header-img/Header4_Mobile.png";
import {fadeInUpBig, fadeInDownBig} from 'react-animations';
import styled, { keyframes } from 'styled-components';
import headerBtn from "../../../assets/fourthpage-images/header-img/headerBtn.png";
import modalPopUp from "../../../assets/fourthpage-images/header-img/modalPopUp.png";
import { useState, useRef, useEffect } from "react";
import emailjs from 'emailjs-com';


const fadeUpAnimation = keyframes`${fadeInUpBig}`;
    ...
    return(
        <div className="brand-container">
            <div className="brand-text">
                <FadeDiv>   
                    <img className="brandDev-text" src={brandText}/>
                    <img className="mobileBD-text" src={HeaderMobile}/>
                </FadeDiv>
                <Fade2Div>
                    <p>We guide clients through branding development to achieve a cohesive, 
                    strong brand that penetrates the marketplace and wins the customer's heart</p>
                </Fade2Div>
                    <div className="header-btn">
                        <button onClick={setClicked}>
                            <span>Build Awareness Now!</span>
                            <img src={headerBtn}/>
                        </button>
                    </div>
                    {clicked? 
